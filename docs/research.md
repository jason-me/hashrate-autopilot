...
- **Income** = sum of coinbase-tx outputs credited to the payout address, captured via bitcoind RPC or Electrs against whatever Bitcoin node the operator has configured.
